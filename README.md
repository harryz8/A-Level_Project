...
![](readme_images/Picture11.5.png)

3.	Click the button "Add Account"

![](readme_images/Picture12.5.png)
...
2.	Type a search term and press enter or the symbol ![](readme_images/Picture17.png).
3.	Please wait.
...
1.	Click the sort icon ![](readme_images/Picture21.png).
2.	Click a sorting method of your choice and click "Sort".

![](readme_images/Picture22.png)
...
![](readme_images/Picture23.png)

## How to Go Back to Home
To get back to the home, click the house button ![](readme_images/Picture24.png).
...
![](readme_images/Picture25.png)

This will redirect you to the item's store's website for this item.

![](readme_images/Picture26.png)

## How to Use the List Functionality
When results are being displayed, the add to list button ![](readme_images/Picture27.png) can be pressed to add that item to the current list.
If you click the list button ![](readme_images/Picture28.png), you can view the current list, or, if you are <heavy>signed in</heavy>, can import saved lists.

![](readme_images/Picture29.png)

If you click "Current List", you can view the items you currently have in your list.

![](readme_images/Picture30.png)
...
If you are <heavy>signed in</heavy>, there will be a save button on the sidebar ![](readme_images/Picture31.png). If you click this, it will prompt you for a name for the list:

![](readme_images/Picture32.png)
...
![](readme_images/Picture33.png)

You need to click a chosen list, and then click "Load". The list will be re-imported and the prices will be updated to their latest values. <heavy>Note: When a list is imported it will overwrite the current list.</heavy>

![](readme_images/Picture34.png)
